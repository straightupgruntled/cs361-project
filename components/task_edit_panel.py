...
from components.extra_gui import ColoredBoxLayout
...
class TaskEditPanel(ColoredBoxLayout):
    def __init__(self, **kwargs):
        ...
        header = BoxLayout(
            size_hint_y=None, height=80, pos_hint={"hcenter_x": 0.5, "top": 1}
        )
        ...
        name_label = Label(
            text="Task Name", font_name="BodyFont", size_hint_y=None, height=20
        )

        self.name_input = TextInput(
            multiline=False, font_name="BodyFont", size_hint_y=None, height=40
        )

        desc_label = Label(
            text="Task Description", font_name="BodyFont", size_hint_y=None, height=20
        )

        self.desc_input = TextInput(multiline=True, font_name="BodyFont")
    ...
    def confirm_delete(self, instance):
        ...
        label = Label(
            text=f"Delete task:\n\n'{self.current_task.name}'?", halign="center"
        )
