...
class TaskCard(RoundedBoxLayout):
    def __init__(self, task_data, **kwargs):
        super().__init__(
            orientation="vertical", size_hint_y=None, height=120, padding=10, **kwargs
        )
    ...
    def delete_task(self, instance):
        ...
        confirm_btn = Button(
            text="Confirm", font_name="TitleFont", background_color=(0.7, 0.2, 0.2, 1)
        )

        cancel_btn = Button(text="Cancel", font_name="TitleFont")
